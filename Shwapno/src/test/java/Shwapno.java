...
public class Shwapno {
	...
	public static void chooseLocation() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='ctl00_ContentPlaceHolder1_ctl00_ctl01_Login1_UserName']")).sendKeys("shazzadur.rahman007@gmail.com");
		Thread.sleep(1000);

		driver.findElement(By.xpath("//input[@id='ctl00_ContentPlaceHolder1_ctl00_ctl01_Login1_Password']")).sendKeys("abcd6570");
		Thread.sleep(1000);
...
//		driver.findElement(
//				By.xpath("//div[@id='myaccount']//a[contains(@class,'header-login-link')][normalize-space()='login']"))
//				.click();
//		Thread.sleep(1000);
//
//		driver.findElement(By.xpath("//a[normalize-space()='Login with Email']")).click();
//		Thread.sleep(1000);
//
//		driver.findElement(By.xpath("//input[@id='ctl00_ContentPlaceHolder1_ctl00_ctl01_Login1_UserName']"))
//				.sendKeys("shazzadur.rahman007@gmail.com");
//		Thread.sleep(1000);
//
//		driver.findElement(By.xpath("//input[@id='ctl00_ContentPlaceHolder1_ctl00_ctl01_Login1_Password']"))
//				.sendKeys("abcd6570");
//		Thread.sleep(1000);
//
//		driver.findElement(By.xpath("//input[@id='ctl00_ContentPlaceHolder1_ctl00_ctl01_Login1_LoginImageButton']"))
//				.click();
//		Thread.sleep(1000);
//
//	}
